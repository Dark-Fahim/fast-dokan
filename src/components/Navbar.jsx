        ...
        <div className="flex flex-col gap-3 ">
            ...
            <div className="flex justify-between items-center">
                <div className="flex gap-4 items-center">
                    ...
                    <div>
                        <input type="text" name="" placeholder="Search here" className="p-2 md:flex hidden text-lg border-2 border-[#06923E] w-80 h-12 rounded-full" id="" />
                    </div>
            ...
            <div className="flex flex-col md:flex-row justify-between items-center">
                ...
                <div className="md:flex  hidden items-center gap-6 font-semibold">
